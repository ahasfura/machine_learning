...
[test_error1, val_error1]=lr_test('stdev1', [1,2], 10000)
[test_error2, val_error2]=lr_test('stdev2', [3,4], 10000)
[test_error4, val_error4]=lr_test('stdev4', [5,6], 10000)
[test_errorn, val_errorn]=lr_test('nonsep', [7,8], 10000)