...
We first use a logistic regression classifier. Table 3 shows the resulting error and most predictive feature for different values of $\lambda$.
...
We evaluate the performance of a SVM classifier. Table 4 shows the resulting errors and most predictive feature for different values of $C$.
