...
for i in range(30):
    ...
    weights = {
        'wd1': tf.Variable(tf.random_normal([28*28, 1000])), # fully connected, 7*7*64 inputs, 1024 outputs
        'out': tf.Variable(tf.random_normal([1000, n_classes])) # 1024 inputs, 10 outputs (class prediction)
    }
