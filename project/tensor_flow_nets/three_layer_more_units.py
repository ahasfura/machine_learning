...
weights = {
    'wd1': tf.Variable(tf.random_normal([28*28, 500])), # fully connected, 7*7*64 inputs, 1024 outputs
    'wd2': tf.Variable(tf.random_normal([500, 300])), # fully connected, 7*7*64 inputs, 1024 outputs
