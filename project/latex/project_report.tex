...
In regards to time complexity, it is evident that the bottleneck of the function is back-propagation. Therefore the time complexity is related to the number parameters.
